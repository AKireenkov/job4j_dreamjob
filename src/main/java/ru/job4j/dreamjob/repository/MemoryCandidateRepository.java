...
public class MemoryCandidateRepository implements CandidateRepository {
    ...
    public MemoryCandidateRepository() {
        save(new Candidate(0, "Andrey", "Java Dev", LocalDateTime.now(), 2, 0));
        save(new Candidate(0, "Petr", "Mentor", LocalDateTime.now(), 1, 0));
        save(new Candidate(0, "Ivan", "QA", LocalDateTime.now(), 3, 0));
        save(new Candidate(0, "Dmitriy", "PM", LocalDateTime.now(), 1, 0));
        save(new Candidate(0, "Denis", "Analytics", LocalDateTime.now(), 3, 0));
    }
